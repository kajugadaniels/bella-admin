...
const MiniUserRow = ({ user, right }) => {
    ...
    return (
        <div className="flex items-center gap-3 rounded-lg p-2 transition-colors hover:bg-black/[0.04]">
            <div
...
function StaffRemoveDialog({
    ...
    return (
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent className="glass-dialog w-[min(520px,calc(100vw-1rem))] rounded-2xl border border-black/5 bg-white/85 p-0 backdrop-blur-xl">
                ...
                <div className="space-y-3 p-4">
                    <div className="rounded-xl border border-black/5 bg-white/70 p-3 text-sm text-neutral-700">
                        The removal is immediate and cannot be undone. {isAdmin ? "They are an admin." : "They are a staff member."}
                    </div>

                    {isAdmin && (
                        <label className="flex items-start gap-3 rounded-xl border border-amber-300/60 bg-amber-50/80 p-3 text-amber-800">
                            <Checkbox
                ...
                <AlertDialogFooter className="flex items-center justify-end gap-2 border-t border-black/5 bg-white/80 p-3">
                    ...
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        ...
                        <div className="lg:col-span-2">
                            <Tabs defaultValue="admins" className="w-full">
                                <TabsList className="grid w-full grid-cols-3 rounded-2xl border border-neutral-200/80 bg-white/70 p-1 backdrop-blur-md">
                                    <TabsTrigger
                                        value="admins"
